...
# gets the path of the current file, and then finds the piano.jpeg
# file relative to SessionHistory.py
image_path = path.join(path.split(__file__)[0], 'piano.jpeg')
