...
class IntroWindow:
     ...
     def __init__(self, mainWindow):
         ...
         text = "Please create a new session or load a previous session to begin using the application. If you don't create or load a session, a temporary session will be used."
